...
public abstract class UCollectionCommon {
	...
	protected static <I, C extends Collection<I>> @NonNull C collectionAddAll(@NonNull C collection, @NonNull I[] elements) {
	 ...
	 */
	protected static <I, C extends Collection<I>> @NonNull C collectionAddAll(@NonNull C collection,
		@NonNull Iterator<I> iterator) {
		UAssert.paramNotNull(collection, "<C extends Collection<I>> collection");
	 ...
	 */
	protected static <I, V extends Vector<I>> @NonNull V vectorAddAll(@NonNull V vector, @NonNull I[] elements) {
	 ...
	 */
	protected static <I, V extends Vector<I>> @NonNull V vectorAddAll(@NonNull V vector, @NonNull Iterator<I> iterator) {
		UAssert.paramNotNull(vector, "<V extends Vector<I>> vector");
		UAssert.paramNotNull(iterator, "Iterator<I> iterator");
	 ...
	 */
	protected static <I, D extends Deque<I>> @NonNull D dequeAddAll(@NonNull D deque, @NonNull I[] elements) {
	 ...
	 */
	protected static <I, D extends Deque<I>> @NonNull D dequeAddAll(@NonNull D deque, @NonNull Iterator<I> iterator) {
		UAssert.paramNotNull(deque, "<D extends Deque<I>> deque");
	 ...
	 */
	protected static <O, R, CO extends Collection<O>, CR extends Collection<R>> @NonNull CR collectionTransform(
		@NonNull CO original,
		@NonNull Function<O, R> mapper,
		@NonNull Supplier<CR> supplier
	) {
	 ...
	 */
	protected static <O, R, VO extends Vector<O>, VR extends Vector<R>> @NonNull VR vectorTransform(
		@NonNull VO original,
		@NonNull Function<O, R> mapper,
		@NonNull Supplier<VR> supplier
	) {
	 ...
	 */
	protected static <O, R, DO extends Deque<O>, DR extends Deque<R>> @NonNull DR dequeTransform(
		@NonNull DO original,
		@NonNull Function<O, R> mapper,
		@NonNull Supplier<DR> supplier
	) {
