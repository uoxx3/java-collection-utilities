...
public final class UStack extends UCollectionCommon {
	 ...
	 * @return a new stack containing all the elements
	 */
	public static <T> @NotNull Stack<T> make(@NotNull Iterator<T> iterator) {
	 ...
	 * @return a new stack containing all the elements
	 */
	public static <T> @NotNull Stack<T> make(@NotNull Collection<T> collection) {
	 ...
	 */
	public static <O, R> @NotNull Stack<R> transform(@NotNull Stack<O> original, @NotNull Function<O, R> mapper) {
