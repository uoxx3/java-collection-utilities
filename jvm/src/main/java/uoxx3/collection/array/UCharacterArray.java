...
public interface UCharacterArray extends UArrayType<Character>, UCopyable<UCharacterArray> {
	 ...
	 * @param element The element to add
	 */
	void add(@Range(from = Character.MIN_VALUE, to = Character.MAX_VALUE) int element);
	 ...
	 */
	void addAll(int @Range(from = Character.MIN_VALUE, to = Character.MAX_VALUE) ... elements);
	 ...
	 */
	boolean contains(@Range(from = Character.MIN_VALUE, to = Character.MAX_VALUE) int value);
	 ...
	 * 	value is not found.
	 */
	int indexOf(@Range(from = Character.MIN_VALUE, to = Character.MAX_VALUE) int value);
	 ...
	 */
	int lastIndexOf(@Range(from = Character.MIN_VALUE, to = Character.MAX_VALUE) int value);
